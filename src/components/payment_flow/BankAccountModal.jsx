        ...
        <Box w="full">
          ...
          >
            ...
            <Flex gap="5px" w="full">
              ...
              <Text fontSize={{base: '12px', md: '11px'}} fontWeight={400} color="text.3">
          ...
          <Button onClick={modal.onClose} color="white" w="full" bg="primary" h="49px">
            Done
          </Button>
        </Box>
      )}
